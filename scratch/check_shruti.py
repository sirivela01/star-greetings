...
queries = [
    "Charuseela Srimanthudu lyrics",
    "Charuseela Srimanthudu song",
    "Charuseela lyrics"
]
...
for q in queries:
    ...
    # Check top 8 vids to skip the one we know fails (aKzsXx3LcgU)
    for vid in vids[:8]:
        if vid == "aKzsXx3LcgU":
            continue
        ...
        if ok:
            ...
            print(f"FOUND SUCCESS: {vid} ({title_clean})")
            found = True
            break
    if found:
        break
